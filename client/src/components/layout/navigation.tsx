      ...
      <nav className="container mx-auto px-4 h-16 flex items-center">
        ...
        <div className="hidden lg:flex items-center gap-4">
          <Button
            ...
            className="text-white dark:text-white hover:text-white/80 dark:hover:text-white/80 hover:scale-110 transition-transform"
          >
            {theme === "dark" ? (
          ...
          <SheetContent className="w-[300px] bg-[#CC3333] dark:bg-[#CC3333] text-white dark:text-white">
            <div className="flex flex-col gap-4 mt-8">
              ...
              <Button
                ...
                className="flex items-center gap-2 justify-start text-white dark:text-white hover:text-white/80 dark:hover:text-white/80 hover:translate-x-2 transition-transform"
              >
                {theme === "dark" ? (
                  <Sun className="h-5 w-5" />
                ) : (
